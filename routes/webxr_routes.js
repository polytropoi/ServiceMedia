                            ...
                            locationButton = "<div style=\x22float: right; margin: 10px 10px;\x22 onclick=\x22ShowHideGeoPanel()\x22><i class=\x22fas fa-globe fa-2x\x22></i></div>";
                                ...
                                ///////////////// - First Person camera - /////////////////        
                                    ...
                                    if (!useSuperHands && !useStarterKit) { //if not superhands or starterkit, use default oculus-touch controls + aframe hands 
                                            ...
                                            handEntities = "<a-entity id=\x22left-hand\x22 hand-tracking-grab-controls=\x22hand: left\x22 thumbstick-logging lefthand_xr_listener oculus-touch-controls=\x22hand: left\x22 "+blinkMod+" handModelStyle: lowPoly; color: #ffcccc\x22 >"+
                                            // console + 
                                            ...
                                            "<a-entity id=\x22right-hand\x22 oculus-touch-controls=\x22hand: right\x22 laser-controls=\x22hand: right;\x22 handModelStyle: lowPoly; color: #ffcccc\x22 raycaster=\x22objects: .activeObjexRay;\x22 grab >"+
                ...
                function (callback) { //DEPRECATED!//not yet... still used for "cloud_markers", vs "local_markers" 
                    if (locationPlaceholders.length > 0) {
                        for (let i = 0; i < locationPlaceholders.length; i++) {
                            ...
                            placeholderEntities = placeholderEntities + "<a-entity data-isvisible=\x22yes\x22 id=\x22"+locationPlaceholders[i].timestamp+"\x22 class=\x22activeObjexGrab activeObjexRay envMap placeholders\x22 cloud_marker=\x22phID: "+
