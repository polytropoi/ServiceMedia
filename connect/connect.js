...
function ReturnLocationTable () {
   ...
   if (sceneLocations.locationMods != null && sceneLocations.locationMods.length > 0) {
      ...
      for (let i = 0; i < sceneLocations.locationMods.length; i++) {
         ...
         if (sceneLocations.locationMods[i].markerType != undefined && (sceneLocations.locationMods[i].markerType == "poi" || sceneLocations.locationMods[i].markerType == "placeholder" || sceneLocations.locationMods[i].markerType == "mailbox") ) {
         ...
         if (keyType.toLowerCase().includes("beat")) {
            ...
            for (let i = 0; i < beatElements.length; i++) {
               if (beatElements[i].components.mod_model != undefined) {
                  beatElements[i].components.mod_model.beat(.75);
               }
               if (beatElements[i].components.cloud_marker != undefined) {
                  beatElements[i].components.cloud_marker.beat(.15);
               }
               }
